...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Edit Goods&Tranport Reservation</h1>
        <a  href="{{ route('tourtravel.index') }}"  class="  btn btn-sm bg-dark shadow-sm text-white"><i
            class="fas fa-plus fa-sm text-success "></i> Show All Goods&Tranport Reservations </a>
    </div>


    <form action="{{ route('goodstransport.update',$editreservation->id) }}" method="POST" enctype="multipart/form-data" >
        @csrf
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <strong>Fratel Information</strong>
                </div>
                <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <div class="card-body">
                         ...
                         <div class="form-group">
                            ...
                            <select class="form-control" name='customer_id'>
                                ...
                                <option value="{{$customer->id}}" @if($editreservation->customer_id == $customer->id ) {{'selected'}} @endif>{{$customer->name}}({{$customer->phone}})</option>
                                @endforeach
                            </select>
                         </div>
                        </div>
                        ...
                        <div class="card-body">
                         ...
                         <div class="form-group">
                            ...
                            <select class="form-control" name="driver_id">
                                ...
                                <option value="{{$driver->id}}" @if($editreservation->driver_id == $driver->id ) {{'selected'}} @endif>{{$driver->name}}({{$driver->phone}})</option>
                                @endforeach
                            </select>
                         </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="vehicle_type" >
                                    <option value="flatbed" @if($editreservation->vehicle_type == 'flatbed') {{'selected'}} @endif>FLATBED</option>
                                    <option value="container" @if($editreservation->vehicle_type == 'container') {{'selected'}} @endif>CONTAINER</option>
                                    <option value="halfbody" @if($editreservation->vehicle_type == 'halfbody') {{'selected'}} @endif>HALFBODY</option>
                                    <option value="mazda" @if($editreservation->vehicle_type == 'mazda') {{'selected'}} @endif>MAZDA</option>
                                    <option value="shehzore" @if($editreservation->vehicle_type == 'shehzore') {{'selected'}} @endif>SHEHZORE</option>
                                    <option value="pickup" @if($editreservation->vehicle_type == 'pickup') {{'selected'}} @endif>PICKUP</option>
                                </select>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="goods_type" >
                                    <option value="fmcg"  @if($editreservation->vehicle_type == 'fmcg') {{'selected'}} @endif >FMCG</option>
                                    <option value="agriculture"  @if($editreservation->vehicle_type == 'agriculture') {{'selected'}} @endif>AGRICULTURE</option>
                                    <option value="steel"  @if($editreservation->vehicle_type == 'steel') {{'selected'}} @endif>STEEL</option>
                                    <option value="construction"  @if($editreservation->vehicle_type == 'construction') {{'selected'}} @endif>CONSTRUCTION</option>
                                    <option value="coal"  @if($editreservation->vehicle_type == 'coal') {{'selected'}} @endif>COAL</option>
                                    <option value="furniture"  @if($editreservation->vehicle_type == 'furniture') {{'selected'}} @endif>FURNITURE</option>
                                    <option value="oil"  @if($editreservation->vehicle_type == 'oil') {{'selected'}} @endif>OIL</option>
                                    <option value="paper"  @if($editreservation->vehicle_type == 'paper') {{'selected'}} @endif>PAPER</option>
                                </select>
                     ...
                     <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label>Pick-Up Location</label>*<small>{{$editreservation->pick_up_location}}</small>
                                        <div id="divSearch"></div>
                                        <div id="map"></div>
                                        <input type="text" id="locationTpl" class="form-control" name="pick_up_location" value="{{old('pick_up_location',$editreservation->pick_up_location)}}" />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label>Drop-Off Location</label>*<small>{{$editreservation->drop_off_location}}</small>
                                        <div id="divSearchtwo"></div>
                                        <div id="map"></div>
                                        <input type="text" id="locationTpltwo" class="form-control" name="drop_off_location" value="{{old('drop_off_location',$editreservation->drop_off_location)}}" />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="weight_of_transport" id="weight_of_transport" value="{{old('weight_of_transport',$editreservation->weight_of_transport)}}" Placeholder="Enter weight_of_transport" />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="rate_per_hour" id="rate_per_hour" value="{{old('rate_per_hour',$editreservation->rate_per_hour)}}" placeholder="Enter rate_per_hour" />
                    ...
                    <div class="card-body">
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="number" class="form-control total_rate_amount" disabled   value="{{old('total_hourly_rate_amount',$editreservation->total_rate_amount)}}" placeholder="0.00">
                              <input type="hidden" class="form-control total_rate_amount"   name="total_rate_amount"  value="{{old('total_hourly_rate_amount',$editreservation->total_rate_amount)}}" placeholder="0.00">
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Goods And Transport Reservation Preview</button>
        </div>
    </form>
...
@section('scripts')
    ...
    <script>
        ...
        function calculate()
        {
            var total_hourly_rate_amount =isNaN(parseInt($('.total_rate_amount').val())) ? 0 : parseInt($('.total_rate_amount').val()) ;
