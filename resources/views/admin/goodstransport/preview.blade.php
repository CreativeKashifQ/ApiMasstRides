...
<div class="container-fluid">
        ...
        <div class="modal-body">
          ...
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            @endif
            <div class="card">
                <div class="card-header font-weight-bold">Goods & Transport Reservation Preview Details</div>
                <div class="card-body">
                   <div class="row">
                    <div class="mx-auto">

                        <a href="{{ route('goodstransport.save',$reservatoin_preview_detail->id) }}" class="btn btn-success btn-sm">Save Reservation</a>
                        <a href="{{ route('goodstransport.edit', $reservatoin_preview_detail->id) }}" class="btn btn-dark btn-sm">Edit Reservation</a>
                        <a href="{{ route('goodstransport.invoice', $reservatoin_preview_detail->id) }}" class="btn btn-primary btn-sm">Download Invoice</a>
                    </div>
                   </div>
                </div>
            </div>
 <div id="printPage">
        ...
        <div class="row ">
            ...
            <div class="card">
                <div class="card-header">
                    <strong>Vehilce Category</strong>
                </div>
                <div class="card-body">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <h4>{{$reservatoin_preview_detail->vehicle_type}}</h4>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-6 col-6">
                                    <strong>Goods Type:</strong><br>
                                </div>

                                <div class="col-md-6 col-6">
                                    <h4>{{$reservatoin_preview_detail->goods_type}}</h4>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       <div class="row">
                           ...
                           <div class="col-6">
                            <h3>{{$reservatoin_preview_detail->pick_up_location}}</h3>
                           </div>
                       </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                         <h3>{{$reservatoin_preview_detail->drop_off_location}}</h3>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-6">
                         <h4>Weight Of Transport : </h4>
                        </div>
                        <div class="col-6">
                         <h3>{{$reservatoin_preview_detail->weight_of_transport}}</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                         <h3>{{$reservatoin_preview_detail->rate_per_hour}}</h3>
                        </div>
                    </div>
