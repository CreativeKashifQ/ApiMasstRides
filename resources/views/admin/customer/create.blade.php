...
<style>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between">
            <div>
                <h5 class=" mb-0 text-green font-weight-bold">New Customer</h5>
            </div>
            <div>
                        ...
                        <div class="col-md-6 offset-md-3  ">
                            ...
                            <div class="bg-white p-4" style="border-radius:10px;">
                                ...
                                <div class="text-center ">
                                    <h5 class="font-weight-bold text-green">Add New Customer</h5>
                                </div>
                                {{-- name --}}
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('name') }}" name="name" placeholder="Noman Shaukat">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="email"
                                        ...
                                        value="{{ old('email') }}" name="email" placeholder="abc@gmail.com">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('phone') }}" name="phone" maxlength="11" placeholder="03012345678">
                                ...
                                <div class="form-group">
                                    <div class=" d-flex d-inline justify-content-end ">
                                        ...
                                        <button type="submit" class="btn bg-green btn-sm rounded-0 text-white ml-1"><i
                                                class="fas fa-plus fa-sm text-white pr-2 "></i>Add Customer</button>
                                    </div>
