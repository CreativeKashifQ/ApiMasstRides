...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-color-black">Add Vehicle Expenses Type </h1>
    <div>
  ...
  <form action="{{ route('vehicleexpensetype.store') }}" method="POST" enctype="multipart/form-data" >
    @csrf
              ...
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="type" placeholder="type,eg. repair,service" value="{{old('type')}}">
