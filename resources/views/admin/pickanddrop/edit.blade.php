...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Edit Pick & Drop Reservation</h1>
    ...
    <form action="{{ route('pickanddrop.update',$editreservation->id) }}" method="POST" enctype="multipart/form-data" >
        @csrf
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Update Pick & Drop Reservation Preview</button>
        </div>
    </form>
