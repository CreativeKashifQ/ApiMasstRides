...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add Pick&Drop Reservation</h1>
        <a  href="{{ route('pickanddrop.index') }}"  class="  btn btn-sm bg-dark shadow-sm text-white"><i
            class="fas fa-plus fa-sm text-success "></i> Show All Pick&Drop Reservations </a>
    </div>
    ...
    <form action="{{ route('pickanddrop.store') }}" method="POST" enctype="multipart/form-data" >
        @csrf
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label>Ride type Selected</label>
                              <input type="text" class="form-control" disabled  value="Pick & Drop">
                              <input type="hidden" name="reservation_for" class="form-control"  value="pickanddrop">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="package_rate_id" id="package_rate_id">
                                ...
                                <option value="{{$package_rate->id}}">{{$package_rate->package_name}} (_{{$package_rate->package_price}}_)/Rs.</option>
                                @endforeach
                            </select>
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Pick & Drop Reservation Preview</button>
        </div>
    </form>
