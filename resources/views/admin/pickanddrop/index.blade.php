...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Pick & Drop Reservations Listing</h1>
        <a href="{{ route('reservation.create') }}" class=" float-right d-sm-inline-block btn btn-sm bg-success shadow-sm text-white"><i
        class="fas fa-plus fa-sm text-warning "></i> Add Pick & Drop Reservation </a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex d-inline">
                        <a  href="{{ route('pickanddrop.edit',$reservation->id) }}" class="btn bg-success text-white btn-sm">Edit</a> |
                        <a class="btn bg-danger text-light btn-sm" href="{{ route('pickanddrop.destroy',$reservation->id) }}" >Delete</a>|
                        <a class="btn bg-dark text-light btn-sm" href="{{ route('pickanddrop.invoice',$reservation->id) }}" >Invoice</a>
                    </td>
                </tr>
                @endforeach
                @else
                <tr>
                    <td colspan="22" class="text-center"><strong>No,Pick & Drop Reservation Found, Add Reservations First</strong></td>
                </tr>
                @endif
