...
<div class="container-fluid">
        ...
        <div class="modal-body">
          ...
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            @endif
            <div class="card">
                <div class="card-header font-weight-bold">Pick & Drop Reservation Preview Details</div>
                <div class="card-body">
                   <div class="row">
                    <div class="mx-auto">

                        <a href="{{ route('pickanddrop.save',$reservatoin_preview_detail->id) }}" class="btn btn-success btn-sm">Save Pick & Drop Reservation</a>
                        <a href="{{ route('pickanddrop.edit', $reservatoin_preview_detail->id) }}" class="btn btn-dark btn-sm">Edit Pick & Drop Reservation</a>
                        <a href="{{ route('pickanddrop.invoice', $reservatoin_preview_detail->id) }}" class="btn btn-primary btn-sm">Download Invoice</a>
                    </div>
                   </div>
                </div>
            </div>
