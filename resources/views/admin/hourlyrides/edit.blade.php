...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Edit Hourly Ride Reservation</h1>
    ...
    <form action="{{ route('hourlyrides.update',$editreservation->id) }}" method="POST" enctype="multipart/form-data" >
        @csrf
                        ...
                        <div class="card-body">
                         ...
                         <div class="form-group">
                            ...
                            <select class="form-control" name="driver_id">
                                ...
                                <option value="{{$driver->id}}" @if($editreservation->driver_id == $driver->id ) {{'selected'}} @endif>{{$driver->name}}({{$customer->phone}})</option>
                                @endforeach
                            </select>
                         </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                              ...
                              <input type="number" class="form-control" name="total_hours"  id="total_hours" value="{{old('total_hours',$editreservation->total_hours)}}" placeholder="0.00">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="number" class="form-control hourly_rate_amount"  disabled value="{{old('hourly_rate_amount',$editreservation->hourly_rate_amount)}}"  placeholder="0.00">
                              <input type="hidden" class="form-control hourly_rate_amount"  name="hourly_rate_amount" value="{{old('hourly_rate_amount',$editreservation->hourly_rate_amount)}}"  placeholder="0.00">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="number" class="form-control total_rate_amount" disabled   value="{{old('total_rate_amount',$editreservation->total_rate_amount)}}" placeholder="0.00">
