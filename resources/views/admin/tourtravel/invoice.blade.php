...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Tour&Travel Invoice</title>
	...
	<body>
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
                ...
                @php
                $facilities =  json_decode($reservation->facility);
                @endphp
                <tr class="item">
					<td>Facility</td>
                    <td>
                ...
                <tr class="item">
					<td>Package Name/Price</td>

					<td>@foreach($package_rates as $package_rate) @if($package_rate->id == $reservation->package_rate_id) {{$package_rate->package_name}}( Rs.{{$package_rate->package_price}}) @endif @endforeach</td>
				</tr>
                <tr class="item">
					<td>Vehicle</td>
