...
<div class="container-fluid">
        ...
        <div class="modal-body">
          ...
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            @endif
            <div class="card">
                <div class="card-header font-weight-bold">Tour&Travel Reservation Preview Details</div>
                <div class="card-body">
                   <div class="row">
                    <div class="mx-auto">

                        <a href="{{ route('tourtravel.save',$reservatoin_preview_detail->id) }}" class="btn btn-success btn-sm">Save Reservation</a>
                        <a href="{{ route('tourtravel.edit', $reservatoin_preview_detail->id) }}" class="btn btn-dark btn-sm">Edit Reservation</a>
                        <a href="{{ route('tourtravel.invoice', $reservatoin_preview_detail->id) }}" class="btn btn-primary btn-sm">Download Invoice</a>
                    </div>
                   </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            ...
            @php
                $facilities =  json_decode($reservatoin_preview_detail->facility);
            @endphp
            <div class="card mt-4">
                <div class="card-header">
                ...
                <div class="card-body">
                    @foreach($facilities as $facility)
                        <strong class="text-capitalize"> {{$facility}} , </strong>
                    @endforeach
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-6">
                                    <h4>{{$package_rate->package_price}} Rs.</h4>
                                </div>
                            </div>
                            @endif
                            @endforeach
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       <div class="row">
                           ...
                           <div class="col-6">
                            <h3>{{$reservatoin_preview_detail->dep_date}}</h3>
                           </div>
                       </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                         <h3>{{$reservatoin_preview_detail->arrival_date}}</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                         <h3>{{$reservatoin_preview_detail->passengers}}</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                         <h3>{{$reservatoin_preview_detail->destination}}</h3>
                        </div>
                    </div>
