...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add Engine(Power)</h1>
        <div>
            <a  href="{{ route('engine.index') }}"  class=" float-right d-sm-inline-block btn btn-sm bg-warning shadow-sm  text-dark"><i
                class="fas fa-eye fa-sm text-success "></i> Show Engine(Powers) </a>
        </div>
    </div>
    ...
    <form action="{{ route('engine.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12 col-12">
                ...
                <input type="number"  class="form-control" name="power" placeholder="eg. 18 " value="{{old('power')}}">
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Add Engine(Power)</button>
        </div>
    </form>
