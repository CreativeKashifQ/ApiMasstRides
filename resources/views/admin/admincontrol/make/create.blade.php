...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add Company</h1>
        <div>
    ...
    <form action="{{ route('make.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12 col-12">
                ...
                <input type="text"  class="form-control" name="name" placeholder="eg. Toyota " value="{{old('name')}}">
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Add Company</button>
        </div>
    </form>
