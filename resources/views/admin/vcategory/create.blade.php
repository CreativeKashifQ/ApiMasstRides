...
@section('title','create-Vcategory')
@section('content')
<!-- Begin Franchise Content -->
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add VCategory</h1>
    ...
    <form action="{{ route('vcategory.store') }}" method="POST" >
        @csrf
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Add Vcategory</button>
        </div>
    </form>
