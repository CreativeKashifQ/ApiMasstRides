...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a  href="{{ route('booking.show') }}"  class="  btn btn-sm bg-primary shadow-sm text-white"><i
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        class="fas fa-plus fa-sm text-success "></i> Show Workhop Vehicle </a>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <form action="{{ route('workshopvehicle.update',$editworkshopvehicle->id) }}" method="POST" enctype="multipart/form-data" >
        @csrf
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            <label>Vehicle Name</label>
                              <input type="text" name="vname" class="form-control" placeholder="Vehicle Name" value="{{old('vname',$editworkshopvehicle->vname)}}">
