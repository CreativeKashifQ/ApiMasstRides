...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add Income </h1>
        <div>
    ...
    <form action="{{ route('income.store') }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label>Income</label>
                            <input type="number" class="form-control" name="income" placeholder="Rs." value="{{old('expense_type')}}">
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Add Today Income</button>
        </div>
    </form>
