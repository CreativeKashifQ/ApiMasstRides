...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Edit Income & Expense</h1>
    ...
    <form action="{{ route('income_expense.update',$editincomeexpense->id) }}" method="POST" enctype="multipart/form-data" >
        @csrf
        <div class="modal-body">
          ...
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            @php
            $incomeexpense_ids = json_decode($editincomeexpense->expense);
            @endphp
        <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control js-add-incomeExpenses-multiple" name="expenseIds[]"  multiple="multiple">
                                ...
                                <option value="{{$expense->id}}" {{collect(old('expenseIds',$incomeexpense_ids))->contains($expense->id) ? 'selected' : ''}}    >{{$expense->expense_type}}({{$expense->amount}})</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name ='incomeId'>
                                ...
                                <option value="{{$income->id}}" @if($income->id == $editincomeexpense->income) {{'selected'}} @endif>Rs. {{$income->income}} ( Date: {{$income->date}})</option>
                                @endforeach
                            </select>
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Update Income/Expense Detail</button>
        </div>
    </form>
