...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add Expenses </h1>
    <div>
    ...
    <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" >
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="expense_type" placeholder="eg. oil change" value="{{old('expense_type')}}">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label>Details</label>
                              <textarea class="form-control" cols="1" rows="1" name="details" placeholder="Some Detals">{{old('details')}}</textarea>
                 ...
                 <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                             ...
                             <textarea class="form-control" placeholder="Any Important Note For Expense" name="notes">{{old('notes')}}</textarea>
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Add Expense</button>
        </div>
    </form>
