...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-color-black">Add Vehicle</h1>
            <div class="d-flex d-inline justify-content-center ">
                ...
                <a href="{{ route('vehicle.show') }}"
                    class=" float-right mr-2 d-sm-inline-block btn btn-sm bg-warning shadow-sm text-white"><i
                        class="fas fa-eye fa-sm text-success "></i> Show Vehicles </a>
                <a href="{{ route('reservation.create') }}"
                    class=" float-right d-sm-inline-block btn btn-sm bg-primary mr-2 shadow-sm text-white"><i
                        class="fas fa-plus fa-sm text-success "></i> Add Reservation </a>
                <a href="{{ route('tourtravel.create') }}"
                    class=" float-right d-sm-inline-block btn btn-sm bg-success mr-2 shadow-sm text-white"><i
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        ...
                                        <option value="car" @if (old('type') == 'car') {{ 'selected' }} @endif>Car</option>
                                        <option value="truck" @if (old('type') == 'truck') {{ 'selected' }} @endif>Truck</option>
                                        <option value="bus" @if (old('type') == 'bus') {{ 'selected' }} @endif>Bus</option>
                                    </select>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="transmission">
                                        <option value="standard" @if (old('standard') == 'standard') {{ 'selected' }} @endif>Standard</option>
                                        <option value="automation" @if (old('automation') == 'automation') {{ 'selected' }} @endif>Automation</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="engine">
                                        ...
                                        @foreach ($engines as $engine)
                                            <option value="{{ $engine->id }}" @if (old('engine') == $engine->id) {{ 'selected' }} @endif>{{ $engine->power }} (cc)</option>
                                        @endforeach
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tracker">
                                        <option value="yes" @if (old('tracker') == 'yes') {{ 'selected' }} @endif>Yes</option>
                                        <option value="no" @if (old('tracker') == 'no') {{ 'selected' }} @endif>No</option>
                                    </select>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="availability">
                                        <option value="available" @if (old('available') == 'available') {{ 'selected' }} @endif>Available</option>
                                        <option value="onrent" @if (old('available') == 'onrent') {{ 'selected' }} @endif>OnRent</option>
                                        <option value="goodstransport" @if (old('available') == 'goodstransport') {{ 'selected' }} @endif>Good&Transport</option>
                                        <option value="function" @if (old('available') == 'function') {{ 'selected' }} @endif>Function</option>
                                        <option value="tourstravel" @if (old('available') == 'tourstravel') {{ 'selected' }} @endif>Tours&Travel</option>
                                        <option value="hourlyrides" @if (old('available') == 'hourlyrides') {{ 'selected' }} @endif>HourlyRides</option>
                                        <option value="outofcity" @if (old('available') == 'outofcity') {{ 'selected' }} @endif>OutOfCity</option>
                                        <option value="pickdrop" @if (old('available') == 'pickdrop') {{ 'selected' }} @endif>Pick&Drop</option>
                                        <option value="accident" @if (old('accident') == 'accident') {{ 'selected' }} @endif>Accident</option>
                                        <option value="maintenance" @if (old('maintenance') == 'maintenance') {{ 'selected' }} @endif>Maintenance</option>
                                        <option value="sold" @if (old('sold') == 'sold') {{ 'selected' }} @endif>Sold</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="branch">
                                        ...
                                        @foreach ($franchises as $franchise)
                                            <option value="{{ $franchise->id }}" @if (old('branch') == $franchise->id) {{ 'selected' }} @endif>{{ $franchise->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="inputAddress" class="text-color-black">Location</label>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="vcategory">
                                        <option value="economy" @if (old('economy') == 'economy') {{ 'selected' }} @endif>Economy</option>
                                        <option value="business" @if (old('business') == 'business') {{ 'selected' }} @endif>Business</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class=" d-flex justify-content-center pb-3">
                                    <img id="showImage" src="{{ asset('images/vehiclepic.png') }}" alt="car image"
