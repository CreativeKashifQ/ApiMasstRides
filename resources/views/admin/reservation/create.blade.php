...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Add Rent A Car Reservation</h1>
        <a  href="{{ route('reservation.index') }}"  class="  btn btn-sm bg-dark shadow-sm text-white"><i
            class="fas fa-plus fa-sm text-success "></i> Show All Rent a Car Reservations </a>
    </div>
    ...
    <form action="{{ route('reservation.store') }}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label>Ride type Selected</label>
                              ...
                              <input type="hidden" name="reservation_for" class="form-control"  value="rentacar">
                        ...
                        <div class="card-body">
                         ...
                         <div class="form-check-inline pt-2 pl-2">
                            <label class="form-check-label">
                              <input type="checkbox" class="form-check-input" style="width:15px; height:15px;" name="self"  value="yes"> <strong>Self ?</strong>
                            </label>
                          </div>
                        </div>
                        </div>
        ...
        <div class="modal-footer">
            <button type="submit"  class="btn bg-success btn-sm rounded-0 text-white">Rent A Car Reservation Preview</button>
        </div>
    </form>
