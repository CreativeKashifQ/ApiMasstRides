...
<div class="container-fluid">
        ...
        <div class="modal-body">
          ...
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            @endif
            <div class="card">
                <div class="card-header font-weight-bold">Reservation Preview Details</div>
                <div class="card-body">
                   <div class="row">
                    <div class="mx-auto">

                        <a href="{{ route('reservation.save',$reservatoin_preview_detail->id) }}" class="btn btn-success btn-sm">Save Reservation</a>
                        <a href="{{ route('reservation.edit', $reservatoin_preview_detail->id) }}" class="btn btn-dark btn-sm">Edit Reservation</a>
                        <a href="{{ route('reservation.invoice', $reservatoin_preview_detail->id) }}" class="btn btn-primary btn-sm">Download Invoice</a>
                    </div>
                   </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            ...
            @if($reservatoin_preview_detail->self == 'no')
            <div class="card mt-4">
            ...
            @else
            <div class="card">
                <div class="card-header"><strong>Status (Self Drive ?)</strong></div>
                <div class="card-body">
                    <strong>{{$reservatoin_preview_detail->self}}</strong>
                </div>
            </div>
            @endif
