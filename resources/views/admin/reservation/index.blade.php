...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-color-black">Rent a Car Reservations Listing</h1>
        <a href="{{ route('reservation.create') }}" class=" float-right d-sm-inline-block btn btn-sm bg-success shadow-sm text-white"><i
        class="fas fa-plus fa-sm text-warning "></i> Add Rent a Car Reservation </a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex d-inline">
                        <a  href="{{ route('reservation.edit',$reservation->id) }}" class="btn bg-success text-white btn-sm">Edit</a> |
                        <a class="btn bg-danger text-light btn-sm" href="{{ route('reservation.destroy',$reservation->id) }}" >Delete</a>|
                        <a class="btn bg-dark text-light btn-sm" href="{{ route('reservation.invoice',$reservation->id) }}" >Invoice</a>
                    </td>
                </tr>
                @endforeach
                @else
