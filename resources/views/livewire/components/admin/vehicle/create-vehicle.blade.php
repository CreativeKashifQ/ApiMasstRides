<div>
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5 class="mb-0 text-green font-weight-bold">Add New Vehicle</h5>
        ...
        <form wire:submit.prevent='store' enctype="multipart/form-data">
            ...
            <div class="modal-body p-0">
                {{-- vehicle details --}}
                <div class="card">
                    <div class="card-header bg-green text-white"><strong>Add Details</strong></div>
                    <div class="card-body">
                        <div class="row">
                            {{-- register no --}}
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    @else
                                        <input type="text"
                                            class="form-control @error('vehicle.franchise') is-invalid @enderror" wire:model="franchise"
                                            placeholder="Multan Franchise" readonly>
                                    @endif
