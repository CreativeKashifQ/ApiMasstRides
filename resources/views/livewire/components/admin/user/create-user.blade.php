<div>
    ...
    <div>
        <button wire:click="$set('addUser')" data-toggle='modal' data-target="#AddUserModal"
            class=" float-right d-sm-inline-block btn btn-sm bg-green rounded-0 shadow-sm text-white"><i
                class="fas fa-plus fa-sm text-warning "></i> Add User</button>
    </div>
    <!-- Add Role Modal -->
    <style>
        .modal-full {
    ...
    <div wire:ignore.self class="modal modal-full fade" id="AddUserModal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true" >
        <div class="modal-dialog " role="document">
            <div class="modal-content ">
                <div >
                    <button type="button" class="btn bg-success btn-sm rounded-0 text-white  mt-3 ml-3"
                    style="" data-dismiss="modal">Go Back</button>
                </div>
                            ...
                            <div class='row'>
                                <div class="col-md-4 offset-md-4 ">
                                    ...
                                    <div class="text-center mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="3in"
                                            height="1in" version="1.1"
                                    ...
                                    <div class="bg-light p-4" style="border-radius:10px;">
                                        <div class="text-center ">
                                            <h4 class="font-weight-bold text-green">Add User</h4>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Name</label>
                                            <input type="text" title="Enter name of user , eg Ali, Naeem"
                                                class="form-control  @error('user.name') is-invalid @enderror"
                                                placeholder="Enter Name" wire:model.defer='user.name'>
                                            @error('user.name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" title="abc@gmail.ocm"
                                                class="form-control  @error('user.email') is-invalid @enderror"
                                                placeholder="abc@gmail.com" wire:model.defer='user.email'>
                                            @error('user.email')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('role') is-envalid @enderror"
                                        ...
                                        <div class="form-group">
                                            <label for="name">Select Franchise To Assign</label>
                                            <select class="form-control @error('user.franchise_id') is-envalid @enderror"
                                                wire:model.defer="user.franchise_id">
                                                <option value='null' disabled selected>-- Select Franchise --</option>
                                                    @foreach ($franchises as $key => $franchise)
                                                    <option value="{{$franchise->id}}">MR-{{$franchise->city}}-00{{$franchise->id}}</option>
                                                    @endforeach
                                            </select>
                                            @error('user.franchise_id')
                                                <span class="invalid-feedback">{{ $errors->first('user.franchise_id') }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" title="password_confirmation" class="form-control "
                                                placeholder="*********" wire:model.defer='confirm_password'>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Allow permissions</label>
                                            <div class="row">
                                                @foreach($permissions as $key => $permission)
                                                <div class="col-md-6 col-6">
                                                    <div class="checkbox checbox-switch switch-primary">
                                                        <label>
                                                            <input type="checkbox" wire:model="selectedPermissions" value="{{$permission["per_id"]}}" />
                                                            <span></span>
                                                            {{$permission['name']}}
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class=" d-flex d-inline justify-content-end ">
                                                <button type="button"
                                                    class="btn bg-secondary btn-sm rounded-0 text-white mr-1"
                                                    data-dismiss="modal">Close</button>
                                                <button type="submit"
                                                    class="btn bg-green btn-sm rounded-0 text-white ml-1"><i
                                                        class="fas fa-plus fa-sm text-white pr-2 "></i>Assign Franchise</button>
                                            </div>
