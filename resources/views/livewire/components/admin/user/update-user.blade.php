<div>
        ...
        <div wire:ignore.self class="modal modal-full fade" id="EditUserModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="col-md-4 offset-md-4 ">
                                        ...
                                        <div class="bg-light p-4" style="border-radius:10px;">
                                            <div class="text-center ">
                                                <h4 class="font-weight-bold text-green">Edit User</h4>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('role') is-envalid @enderror"
                                                    ...
                                                    <option value=null disabled selected>-- Select Role --</option>
                                                        <option value="Franchiser"  >Franchise</option>
                                                </select>
                                                @error('role')
                                                ...
                                                <div class=" d-flex d-inline justify-content-end ">
                                                    ...
                                                    <button type="submit"
                                                        class="btn bg-green btn-sm rounded-0 text-white ml-1"><i
                                                            class="fas fa-plus fa-sm text-white pr-2 "></i>Update User</button>
                                                </div>
