...
class HourlyridesController extends Controller
{
    ...
    public function index()
    {
         try {
            ...
            $franchises = Franchise::all();
             return view('admin.hourlyrides.index',compact('reservations','customers','drivers','vehicles','package_rates','franchises'));
        } catch (\Exception $e) {
            return $e->getmessage();
        }
    }
    ...
    public function create()
    {
        ...
        $customers = Customer::all();
        $drivers = Driver::all();
        $package_rates = Packagerate::where('package_for','hourlyrides')->get();
        $vehicles = Vehicle::where('availability','hourlyrides')->get();
        $franchises = Franchise::all();
        return view('admin.hourlyrides.create',compact('customers','drivers','package_rates','vehicles','franchises'));
        } catch (\Exception $e) {
            return $e->getmessage();
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $reservation->total_hours =$request->total_hours;
            $reservation->hourly_rate_amount =$request->hourly_rate_amount;
            ...
            if ($reservation->save()) {
                ...
                $vehicles = Vehicle::all();
                $franchises = Franchise::all();
                return view('admin.hourlyrides.preview',compact('reservatoin_preview_detail','customers','drivers','package_rates','vehicles','franchises'));
            }else{
    ...
    public function save($id)
    {
        ...
        return redirect()->route('hourlyrides.index')->with('success',' Hourly Ride Reservation Saved Successfully');
    }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            $vehicles = Vehicle::where('availability','hourlyrides')->get();
            $franchises = Franchise::all();
            return view('admin.hourlyrides.edit',compact('editreservation','customers','drivers','package_rates','vehicles','franchises'));
        } catch (\Exception $e) {
            return $e->getmessage();
        }
    }
        ...
        try {
           $reservation = Reservation::findOrFail($id);
            if ($reservation->delete()) {
                return redirect()->back()->with('success',' Hourly Ride Reservation Deleted Successfully');
            }
       } catch (\Exception $e) {
           return $e->getmessage();
       }
    ...
    public function invoice($id)
    {
        ...
        try {
            ...
            $package_rates = Packagerate::all();
            $franchises = Franchise::all();
            $pdf = PDF::loadView('admin.hourlyrides.invoice',compact('reservation','vehicles','customers','drivers','package_rates','franchises'));
            return $pdf->download('hourlyridesinvoice.pdf');
        } catch (\Exception $e) {
            return $e->getmessage();
        }
    }
